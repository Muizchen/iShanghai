...
NSString *const MJRefreshAutoFooterIdleText = @"上拉加载";
NSString *const MJRefreshAutoFooterRefreshingText = @"正在加载...";
NSString *const MJRefreshAutoFooterNoMoreDataText = @"加载完毕";

NSString *const MJRefreshBackFooterIdleText = @"上拉加载";
NSString *const MJRefreshBackFooterPullingText = @"松开立即加载";
NSString *const MJRefreshBackFooterRefreshingText = @"正在加载...";
NSString *const MJRefreshBackFooterNoMoreDataText = @"已经没有更多了";